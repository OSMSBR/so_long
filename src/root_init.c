...
/*   Updated: 2024/10/12 21:35:03 by osebbar          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	texture_load(root, &root->player, "./textures/Wizard.xpm");
	texture_load(root, &root->exit, "./textures/door.xpm");
	texture_load(root, &root->coll, "./textures/potion.xpm");
	texture_load(root, &root->wall, "./textures/Wall_fire.xpm");
	texture_load(root, &root->ground, "./textures/Ground.xpm");
}
